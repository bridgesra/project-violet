...
from Reconfigurator.attack_pattern_check import attack_methods_checker
from Reconfigurator.utils import extract_json, cosine_similarity, clean_and_finalize_config
...
def build_config_prompt(schema_path, top_vulns, prev_config=None):
    ...
    config_prompt = (
        ...
        "Requirements:\n"
        "1. Use **1 service**, using the `ssh` protocol.\n"
        "2. Each service must:\n"
        ...
        "3. All **services** should use an LLM plugin.\n"
